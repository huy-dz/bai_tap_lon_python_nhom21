...
#load images
#game_name
title_game = pygame.image.load('img/GAME.png').convert_alpha()
#button images
            ...
            for x, tile in enumerate(row):
                if tile >= 0:
                    ...
                    if tile >= 0 and tile <= 8:
                        ...
                        player = Soldier('player', x * TILE_SIZE, y * TILE_SIZE, 1.65, SPEED, 20)
                        health_bar = HealthBar(10, 10, player.health, player.health)
                    elif tile == 16:#create enemies
                        enemy = Soldier('enemy', x * TILE_SIZE, y * TILE_SIZE, 1.65, 2, 200)
...
#create title
title_game = button.Button(SCREEN_WIDTH // 2 - 190, SCREEN_HEIGHT // 2 - 250, title_game, 1)
